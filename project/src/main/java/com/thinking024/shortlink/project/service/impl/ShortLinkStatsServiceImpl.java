...
package com.thinking024.shortlink.project.service.impl;
...
import com.thinking024.shortlink.project.common.biz.user.UserContext;
import com.thinking024.shortlink.project.common.convention.exception.ServiceException;
import com.thinking024.shortlink.project.dao.entity.*;
import com.thinking024.shortlink.project.dao.mapper.*;
import com.thinking024.shortlink.project.dto.req.ShortLinkGroupStatsAccessRecordReqDTO;
import com.thinking024.shortlink.project.dto.req.ShortLinkGroupStatsReqDTO;
import com.thinking024.shortlink.project.dto.req.ShortLinkStatsAccessRecordReqDTO;
import com.thinking024.shortlink.project.dto.req.ShortLinkStatsReqDTO;
import com.thinking024.shortlink.project.dto.resp.ShortLinkStatsAccessDailyRespDTO;
import com.thinking024.shortlink.project.dto.resp.ShortLinkStatsAccessRecordRespDTO;
import com.thinking024.shortlink.project.dto.resp.ShortLinkStatsBrowserRespDTO;
import com.thinking024.shortlink.project.dto.resp.ShortLinkStatsDeviceRespDTO;
import com.thinking024.shortlink.project.dto.resp.ShortLinkStatsLocaleCNRespDTO;
import com.thinking024.shortlink.project.dto.resp.ShortLinkStatsNetworkRespDTO;
import com.thinking024.shortlink.project.dto.resp.ShortLinkStatsOsRespDTO;
import com.thinking024.shortlink.project.dto.resp.ShortLinkStatsRespDTO;
import com.thinking024.shortlink.project.dto.resp.ShortLinkStatsTopIpRespDTO;
import com.thinking024.shortlink.project.dto.resp.ShortLinkStatsUvRespDTO;
import com.thinking024.shortlink.project.service.ShortLinkStatsService;
...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    private final LinkAccessLogsMapper linkAccessLogsMapper; // 总日志，每一次访问都会插入一条，具体见link.sql文件中的unique key

    private final LinkAccessStatsMapper linkAccessStatsMapper; // 访问总体情况统计，按日期+小时+link统计，插入新数据/更新当前小时的情况
    private final LinkLocaleStatsMapper linkLocaleStatsMapper; // 地区统计，按日期+地区+link统计，插入新数据/更新当天的情况
    private final LinkBrowserStatsMapper linkBrowserStatsMapper; // 浏览器统计，按日期+browser+link统计，插入新数据/更新当天的情况
    private final LinkOsStatsMapper linkOsStatsMapper; // OS统计，按日期+os+link统计，插入新数据/更新当天的情况
    private final LinkDeviceStatsMapper linkDeviceStatsMapper; // 设备统计，按日期+device+link统计，插入新数据/更新当天的情况
    private final LinkNetworkStatsMapper linkNetworkStatsMapper; // 网络统计，按日期+network+link统计，插入新数据/更新当天的情况

    private final LinkGroupMapper linkGroupMapper; // 短链接分组
    ...
    /**
     * 检查操作的link的gid是否属于当前用户
     * 统计功能的所有代码都需要加上这一步校验，防止横向越权
     * 删除/修改短链接的代码则不需要，因为那里已经通过username作为查询字段了，不会操作到其他用户的数据
     */
